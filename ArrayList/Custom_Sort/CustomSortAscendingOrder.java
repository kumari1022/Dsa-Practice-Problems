/*
    Write a Java program to manage and sort student records in descending order.Each student has roll number,
    name,branch,totalmarks and CGPA.Implement custom Comparator classes to sort students by different fields 
    (roll number, name, branch, total, and CGPA).In the main program, read student details, sort them by roll 
    number in descending order, and display the sorted list.
*/
import java.util.*;
class Student {
    int rollno;
...
public class CustomSortAscendingOrder{
